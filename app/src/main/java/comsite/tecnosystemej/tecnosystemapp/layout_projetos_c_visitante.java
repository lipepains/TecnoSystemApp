...
public class layout_projetos_c_visitante extends ActionBarActivity /*vai aparecer o menu*/ {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_projetos_c);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.projetos) {
            Intent it = new Intent(this, layout_projetos_c_visitante.class);
            startActivity(it);
        }
        if (id == R.id.empresa) {
