...
public class layout_membros extends  ActionBarActivity /*vai aparecer o menu*/ {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_membros);
    }

    public void btnDiretoria (View v){

        Intent it = new Intent(this, layout_membros_diretoria.class);
        startActivity(it);
    }

    public void btnMembro_membro (View v){

        Intent it = new Intent(this, layout_membros_membros.class);
        startActivity(it);
    }
