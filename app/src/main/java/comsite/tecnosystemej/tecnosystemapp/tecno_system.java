...
public class tecno_system extends ActionBarActivity /*vai aparecer o menu*/ {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tecno_system);
    }
    ...
    public void btnProjetos(View View){

        Intent It = new Intent(this, layout_projetos.class);
        startActivity(It);
    }
    public void btnMembros(View View){
